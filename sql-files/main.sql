...
CREATE TABLE IF NOT EXISTS `auction` (
  ...
  `rndopt0` int(11) NOT NULL default '0',
  `rndopt1` int(11) NOT NULL default '0',
  `rndopt2` int(11) NOT NULL default '0',
  `rndopt3` int(11) NOT NULL default '0',
  `rndopt4` int(11) NOT NULL default '0',
  `value1_0` int(11) NOT NULL default '0',
  `value1_1` int(11) NOT NULL default '0',
  `value1_2` int(11) NOT NULL default '0',
  `value1_3` int(11) NOT NULL default '0',
  `value1_4` int(11) NOT NULL default '0',
  `value2_0` int(11) NOT NULL default '0',
  `value2_1` int(11) NOT NULL default '0',
  `value2_2` int(11) NOT NULL default '0',
  `value2_3` int(11) NOT NULL default '0',
  `value2_4` int(11) NOT NULL default '0',
